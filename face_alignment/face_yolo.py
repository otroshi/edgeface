...
def face_yolo11_detection(image_paths):
    """
...
if __name__ == "__main__":
    image_paths = [
        ...
        "test/test_images/Another_Person.jpg",  # Replace with actual image paths
    ]
    all_bounding_boxes, all_cropped_faces = face_yolo11_detection(image_paths)